...
mod tests {
    ...
    use crate::{poly_utils::MultilinearPoint, utils::base_decomposition};
    ...
    fn test_evaluation() {
        ...
        let evaluations = (0..num_evaluation_points as u64).map(F::from_canonical_u64).collect();
        ...
        for i in 0..num_evaluation_points {
            ...
            let point = MultilinearPoint(decomp.into_iter().map(F::from_canonical_u8).collect());
